(ns marketentry.store
  "SSoT for the San Marino (SMR) market-entry compliance actor, behind a
...
(defn demo-data
  ...
  `:non-resident?` / `:sm-tax-address-established?` /
  `:industrial-licence-referenced?` are ground truth for the
  `non-resident-tax-address-missing` flagship check (Legge 96/1999 Art.
  11 direct-tax-address requirement); `:requires-operating-licence?` /
  `:operating-licence-verified?` are ground truth for the conditional
  business-operating-licence check (Legge 129/2010)."
  []
  {:engagements
   {"eng-1" {:id "eng-1" :operator "Titano Servizi S.r.l." :portal "gov.sm/pub1/GovSM/Bandi-Appalti-Avvisi-Pubblici.html"
             ...
             :requires-operating-licence? true :operating-licence-verified? true
             :drafted? false :submitted? false
             :jurisdiction "SMR" :status :intake}
    "eng-2" {:id "eng-2" :operator "Atlantis LLC" :portal "gov.sm/pub1/GovSM/Bandi-Appalti-Avvisi-Pubblici.html"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :non-resident? false :sm-tax-address-established? false :industrial-licence-referenced? false
             :requires-operating-licence? true :operating-licence-verified? true
    ...
    "eng-3" {:id "eng-3" :operator "Monte Titano Costruzioni S.p.A." :portal "gov.sm/pub1/GovSM/Bandi-Appalti-Avvisi-Pubblici.html"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             ...
             :drafted? false :submitted? false
             :jurisdiction "SMR" :status :intake}
    "eng-4" {:id "eng-4" :operator "Borgo Maggiore Digital S.r.l." :portal "gov.sm/pub1/GovSM/Bandi-Appalti-Avvisi-Pubblici.html"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             ...
             :drafted? false :submitted? false
             :jurisdiction "SMR" :status :intake}
    "eng-5" {:id "eng-5" :operator "Serravalle Logistics S.r.l." :portal "gov.sm/pub1/GovSM/Bandi-Appalti-Avvisi-Pubblici.html"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :non-resident? false :sm-tax-address-established? false :industrial-licence-referenced? false
             :requires-operating-licence? true :operating-licence-verified? false
             :drafted? false :submitted? false
             :jurisdiction "SMR" :status :intake}}})
...
(defn- engagement->tx [{:keys [id operator portal base-fee monthly-rate monitoring-months claimed-fee
                               non-resident? sm-tax-address-established? industrial-licence-referenced?
                               requires-operating-licence? operating-licence-verified?
                               drafted? submitted?
  ...
  (cond-> {:engagement/id id}
    ...
    (some? non-resident?)                 (assoc :engagement/non-resident? non-resident?)
    (some? sm-tax-address-established?)   (assoc :engagement/sm-tax-address-established? sm-tax-address-established?)
    (some? industrial-licence-referenced?) (assoc :engagement/industrial-licence-referenced? industrial-licence-referenced?)
    (some? requires-operating-licence?)   (assoc :engagement/requires-operating-licence? requires-operating-licence?)
    (some? operating-licence-verified?)   (assoc :engagement/operating-licence-verified? operating-licence-verified?)
...
(def ^:private engagement-pull
  [:engagement/id :engagement/operator :engagement/portal :engagement/base-fee :engagement/monthly-rate
   ...
   :engagement/non-resident? :engagement/sm-tax-address-established? :engagement/industrial-licence-referenced?
   :engagement/requires-operating-licence? :engagement/operating-licence-verified?
...
(defn- pull->engagement [m]
  (when (:engagement/id m)
    {:id (:engagement/id m) :operator (:engagement/operator m) :portal (:engagement/portal m)
     ...
     :non-resident? (boolean (:engagement/non-resident? m))
     :sm-tax-address-established? (boolean (:engagement/sm-tax-address-established? m))
     :industrial-licence-referenced? (boolean (:engagement/industrial-licence-referenced? m))
     :requires-operating-licence? (boolean (:engagement/requires-operating-licence? m))
     :operating-licence-verified? (boolean (:engagement/operating-licence-verified? m))

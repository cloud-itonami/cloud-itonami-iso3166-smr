...
`cloud-itonami-iso3166-smr` is an OSS open-business blueprint. Governance covers both code and
the operator model.
...
San Marino-licensed counsel or a registered agent for whatever licensed
representation the law of San Marino requires for public-procurement
filings (see `docs/business-model.md` for the confirmed public-
procurement / Company Law / business-licensing / tax regime this actor
is scoped to).
